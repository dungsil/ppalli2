 ...
 * @property user 관련 사용자 객체. 이는 N:1 관계이다
 * @property unverifiedEmail 사용자의 미인증 이메일 주소이다
 * @property verificationToken 사용자 검증과 관련된 검증 토큰이다
 * @property tokenExpiredAt 검증 토큰의 만료 타임스탬프이다
 * @property tokenSentAt 검증 토큰이 사용자에게 전송된 시간의 타임스탬프이다
 * @property verifiedAt 사용자 검증이 완료된 시간의 타임스탬프이다
 */
@Entity
