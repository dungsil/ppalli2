 ...
 */
object IdGenerator {
  private val instance = TSID.Factory.INSTANCE
   ...
   *
   * 이 메소드는 18 자의 Long 타입 값을 반환하며, 앞의 10 자는 타임스탬프 뒤의 7 자는 특정 알고리즘에 따른 랜덤 값 (순서보장)
   ...
   */
  fun generateTSID(): Long = this.instance.generate().toLong()
}
